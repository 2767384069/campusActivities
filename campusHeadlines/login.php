...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="wel">欢迎登录</div>
        <form role="form" method="post" action="doAction.php?act=login">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control" id="pw" placeholder="请输入您的邮箱密码">
            </div>
            <div class="form-group">
                <label for="verify">验证码</label>
                <input type="text" name="verify" class="form-control" id="verify" placeholder="输入验证码">
            </div>
            <div><img src="admin/getVerify.php" alt="" /></div><br />
